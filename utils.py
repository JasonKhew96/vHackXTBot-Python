        ...
        while t is None:
            ...
            try:
                ...
                if t == "5":
                    ...
                    logger.info(
                        "Server is down for Maintenance, please be patient.")
                    input('Server down...')
                return t
            except Exception as e:
                logger.error('Error: {}'.format(e))
                logger.info(
                    "Error, trying again. Delaying {0} seconds".format(i))
                time.sleep(1 + i)
            i += 1
